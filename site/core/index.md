...
| `ecosystem/{dotnet,node,gomod,cargo,electron,tauri,velopack,regex}` | built-in adapters (reference impls of `plugin.Ecosystem`): four language adapters, three desktop ecosystems (tauri, electron, velopack), and a generic regex adapter |
