...
**In progress:** Claude queue execution now connects the sealed capture, retained
...
2. **In progress:** connect the durable queue to the Claude capture, commit and
