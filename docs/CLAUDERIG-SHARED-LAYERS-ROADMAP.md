...
| 6b.6b.2d.3b. Windows fenced-store recovery | In review (current PR) | Durable prelaunch/cleanup phases and kernel-incarnation evidence. Unconfirmed jobs require a verified kernel restart; legacy records stay blocked. [Contract](CLAUDERIG-V2-PROCESS-LIFECYCLE.md#windows-fenced-store-recovery-6b6b2d3b). |
