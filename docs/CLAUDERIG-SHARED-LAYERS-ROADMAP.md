...
| 7c.1. Runtime manual-sync coverage | In progress | Bridge validated lifecycle and capture-policy bindings; preserve worker ownership, identity matching, later arrivals and confirmed publication. Internal service only. |
