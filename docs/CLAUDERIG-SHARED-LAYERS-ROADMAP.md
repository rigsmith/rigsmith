...
**In review in [#337](https://github.com/rigsmith/rigsmith/pull/337):** private retained conflict resolution for manifest/device metadata,
...
Restore follow-up for both v1 and v2: validate manifest link endpoints at the
restore boundary, including older or manually edited backups. Retained conflict
decoding is not a substitute for that boundary check.
...
2. **Merged in [#332](https://github.com/rigsmith/rigsmith/pull/332):** connect the durable queue to the Claude capture, commit and
   ...
   Merged in [#336](https://github.com/rigsmith/rigsmith/pull/336): bounded retry/backoff and explicit failure blocking. In review in [#337](https://github.com/rigsmith/rigsmith/pull/337): retained manifest/device
