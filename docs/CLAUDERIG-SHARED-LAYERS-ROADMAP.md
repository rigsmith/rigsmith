...
| 6b.6b.2d.2. Canonical workflow supervision and fenced-store recovery | Next | Bind active staging leases and propagate failures through canonical capture/publication/pull/merge workflows before accepting supervised contexts; prove old writers stopped before recovery. Both gates are required before queued hooks. |
