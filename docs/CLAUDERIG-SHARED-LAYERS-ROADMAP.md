...
| 7c.2a. Manual queue sync command | In progress | Explicit supervised `queue sync` with dry-run/all-flush, current-account coverage and remote confirmation. |
