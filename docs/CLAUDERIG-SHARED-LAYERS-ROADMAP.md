...
| 8b. Codex config portability | In progress | Internal TOML codec (8b.1), [#390](https://github.com/rigsmith/rigsmith/pull/390): structured omission, credential tripwire and secret-preserving restore. Remaining: file/path and hook/customization processing, independent state/repository and sync/restore wiring. [Contract](CODEXRIG-V2-CONFIG-CODEC.md). |
