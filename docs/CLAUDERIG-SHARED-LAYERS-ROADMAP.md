...
| 6b.4b.2b. Safe plan application and restart | In progress | Seal a repair intent, check AUTO_MERGE/live files, durably stage files/index, and resume interrupted writes. [Contract](CLAUDERIG-V2-MERGE-STAGING.md). |
...
2. **Merged in [#332](https://github.com/rigsmith/rigsmith/pull/332):** connect the durable queue to the Claude capture, commit and
   ...
   conflict unions. Native JSONL/memory append recovery merged in [#341](https://github.com/rigsmith/rigsmith/pull/341). [#342](https://github.com/rigsmith/rigsmith/pull/342) added bounded chunk-index recovery. [#343](https://github.com/rigsmith/rigsmith/pull/343) adds ordinary-file snapshot ordering. Merged in [#344](https://github.com/rigsmith/rigsmith/pull/344): completion of already-staged canonical merges. Merged: [#346](https://github.com/rigsmith/rigsmith/pull/346), staged completion before fresh capture. Merged: [#347](https://github.com/rigsmith/rigsmith/pull/347), private unresolved-merge planning. In progress: recoverable file/index application. Next: queue integration, plus exact
