...
| 6b.6b.1. Startup shared-history validation | In review (current PR) | Optional runner preflight and Claude binding/staging checks; fresh complete ancestry without claiming work or initializing/pushing history. [Contract](CLAUDERIG-V2-QUEUE.md#startup-history-check-milestone-6b6b1). |
| 6b.6b.2. Parent-death cleanup and OS restart | Next | Fence external helper lifetimes and validate platform startup/restart before exposing a worker command. |
