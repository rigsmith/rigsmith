...
**In progress:** milestone 6b.2 starts with the shared execution driver and
Claude capture/publication service split. Durable artifact integration, queued
...
| 6b.2. Worker and Claude service integration | In progress | Shared one-batch phase driver and separate Claude Capture/Publish services. Next: durable artifacts and concrete Claude adapter, configuration/provenance validation, retention/deletion protection, child-process ownership and exact manual-sync coverage before exposing queued execution. |
