...
| 7c.2b.2a. Queued worker capture/flush policy | In review: [#385](https://github.com/rigsmith/rigsmith/pull/385) | Complete requested sessions/subagents, honor all-flush, retain unrelated plain-transcript throttling and replay saved artifacts unchanged. |
| 7c.2b.2b. Opt-in hook installation and rollback | Planned | Hook/ordinary-sync routing, producer recovery, stop/drain and rollback validation; ordinary synchronous behavior remains the default. |
