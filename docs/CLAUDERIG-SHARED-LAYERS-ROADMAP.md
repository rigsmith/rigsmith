...
**In progress:** retained publication using existing system Git configuration and
...
1. **In progress:** reuse existing Git/`gh` configuration for retained publication.
