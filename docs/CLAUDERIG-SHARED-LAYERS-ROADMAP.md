...
checks. Layer discovery/freshness, full permission compilation and local readiness remain; 8b.6 is not complete. Stage 8b remains
...
| 8b.6. Supported-version validation | In progress | 8b.6a merged in [#397](https://github.com/rigsmith/rigsmith/pull/397): pinned schema, independent profile overlays and versioned preparation. Provider/MCP rules merged in [#400](https://github.com/rigsmith/rigsmith/pull/400). Current 8b.6b: layer composition and permission catalog/selection checks. Remaining: layer discovery/freshness, permission compilation/other requirements and local readiness. Structural validation does not prove startup readiness. [Contract](CODEXRIG-V2-CONFIG-VALIDATION.md). |
