...
**In review in [#323](https://github.com/rigsmith/rigsmith/pull/323):** concrete HTTPS/local Git transport with explicit credentials and
transport subprocess cancellation/cleanup ([contract](CLAUDERIG-V2-GIT-TRANSPORT.md)).
SSH, authentication discovery, native conflict recovery, remaining process
ownership/parent-death recovery, queued hooks and CodexRig remain planned.
