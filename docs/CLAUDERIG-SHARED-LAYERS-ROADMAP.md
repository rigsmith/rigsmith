...
| 7c.1. Runtime manual-sync coverage | In review: [#381](https://github.com/rigsmith/rigsmith/pull/381) | Bridge validated lifecycle and capture-policy bindings; preserve worker ownership, identity matching, later arrivals and confirmed publication. Internal service only. |
| 7c.2. Opt-in hooks and rollback | Planned | Command/hook routing, stop/drain and rollback validation; ordinary synchronous behavior remains the default. |
