...
| 8a. Codex foundation and separate executable | In review: [#389](https://github.com/rigsmith/rigsmith/pull/389) | `codexrig inspect`, independent source/file policy, shared allowlist and synthetic inventory fixtures. [Contract](CODEXRIG-V2-FOUNDATION.md). |
| 8b. Codex config portability | Next | Structured TOML and hook/config processing, secret-preserving restore, independent tool state and backup repository. |
