...
| 8b. Codex config portability | In progress | TOML codec (8b.1) merged in [#390](https://github.com/rigsmith/rigsmith/pull/390). Current: bounded config file capture (8b.2), [#391](https://github.com/rigsmith/rigsmith/pull/391). Remaining: content path policy, guarded restore, hooks/customizations, independent state/repository and sync/restore wiring. [Capture contract](CODEXRIG-V2-CONFIG-CAPTURE.md). |
