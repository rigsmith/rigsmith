...
**In review in [#327](https://github.com/rigsmith/rigsmith/pull/327):** retained publication using existing system Git configuration and
...
1. **In review in [#327](https://github.com/rigsmith/rigsmith/pull/327):** reuse existing Git/`gh` configuration for retained publication.
