...
| 8a. Codex foundation and separate executable | In progress | `codexrig inspect`, independent source/file policy, shared allowlist and synthetic inventory fixtures. [Contract](CODEXRIG-V2-FOUNDATION.md). |
