...
A follow-up reuses the shared staging-state guard before fresh capture and corrects a Windows chunk fixture whose fixed timestamp could hide rewritten bytes from Git. Automatic repair before fresh capture remains part of 6b.4b.
