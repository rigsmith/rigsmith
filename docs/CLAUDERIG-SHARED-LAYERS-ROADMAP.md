...
| 7b. Explicit queued Claude commands | In review: [#380](https://github.com/rigsmith/rigsmith/pull/380) | Init, saved producer requests, enqueue, supervised foreground worker, status/retry and drain using existing Git credentials and GitHub/GitLab privacy checks (`gh`/`glab` or provider token). [Contract](CLAUDERIG-V2-QUEUE-COMMANDS.md). |
