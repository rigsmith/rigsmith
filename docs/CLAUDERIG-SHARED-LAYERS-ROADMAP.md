...
| 6b.6b.2d. Fenced-store recovery remedy | Next | Recover only with proof that old writers stopped. No automatic timeout, guessed PID termination, or lock-file deletion; required before queued hooks. |
