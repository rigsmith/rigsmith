...
| 7b. Explicit queued Claude commands | In review (current PR) | Init, saved producer requests, enqueue, supervised foreground worker, status/retry and drain using existing Git/`gh` checks. [Contract](CLAUDERIG-V2-QUEUE-COMMANDS.md). |
