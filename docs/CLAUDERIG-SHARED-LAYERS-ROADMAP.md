...
**Current position (after #406):** stages 1–7 and 8a are merged. Config codec,
...
in [#406](https://github.com/rigsmith/rigsmith/pull/406). Current 8b.6b work checks
selected hook headers and secret-source declarations. Production layer discovery/identity checks, full permission compilation and local readiness remain; 8b.6 is not complete. Stage 8b remains
