...
| 7c.2b.2a. Queued worker capture/flush policy | In progress | Complete requested sessions/subagents, honor all-flush, retain unrelated plain-transcript throttling and replay saved artifacts unchanged. |
