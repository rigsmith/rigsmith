...
| 7c.2b.2b.2. Opt-in hook installation and rollback | In review: [#388](https://github.com/rigsmith/rigsmith/pull/388) | Local enable/status/disable commands, queued Stop/SessionEnd, pinned inbox recovery and manual coverage sync. Every rollback attempt requires an empty inbox and idle queue. Portable hooks and the synchronous default are preserved. |
