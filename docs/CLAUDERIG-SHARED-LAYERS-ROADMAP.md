...
**Current position (after #407):** stages 1–7 and 8a are merged. Config codec,
...
merged in [#407](https://github.com/rigsmith/rigsmith/pull/407). Current 8b.6b work
checks inherited matcher declarations and glob syntax. Production layer discovery/identity checks, full permission compilation and local readiness remain; 8b.6 is not complete. Stage 8b remains
