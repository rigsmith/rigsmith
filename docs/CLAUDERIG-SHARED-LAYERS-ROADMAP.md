...
| 7c.2b.2b.1. Durable hook producer and recovery | In review: [#387](https://github.com/rigsmith/rigsmith/pull/387) | Bounded private inbox, saved attribution before admission, replay after uncertain writes and removal after confirmed enqueue. |
| 7c.2b.2b.2. Opt-in hook installation and rollback | Planned | Hook/ordinary-sync routing, end-to-end producer recovery, stop/drain and rollback validation; ordinary synchronous behavior remains the default. |
