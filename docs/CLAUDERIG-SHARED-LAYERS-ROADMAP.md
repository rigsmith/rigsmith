...
| 7c.2a. Manual queue sync command | In review: [#382](https://github.com/rigsmith/rigsmith/pull/382) | Explicit supervised `queue sync` with dry-run/all-flush, current-account coverage and remote confirmation. |
| 7c.2b. Opt-in hooks and rollback | Planned | Hook/ordinary-sync routing, stop/drain and rollback validation; ordinary synchronous behavior remains the default. |
