...
| 7c.2b.2b.2. Opt-in hook installation and rollback | In progress | Local enable/status/disable commands, queued Stop/SessionEnd, manual coverage sync and rollback guarded by an empty inbox and idle queue. Portable hooks and the synchronous default are preserved. |
