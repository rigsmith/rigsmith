...
| 6b.6b.2d. Fenced-store recovery and canonical Git supervision | Next | Prove old writers stopped before recovery; adapt canonical manual-sync Git subprocesses before allowing explicitly supervised sync. Both gates are required before queued hooks. |
