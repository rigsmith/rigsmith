...
| 6b.7a. Queue capacity and receipt compaction | In review (current PR) | Queue payload/headroom and remedy reporting; explicit replay cutoff, schema-3 receipt compaction, preserved unfinished work and monotonic generations. [Contract](CLAUDERIG-V2-QUEUE.md#queue-capacity-and-receipt-compaction-milestone-6b7a). |
| 6b.7b. Artifact capacity and cleanup | Next | Bound/report artifact storage and reclaim disposable captures/seeds/commits and interrupted scratch data while preserving every live reference and recovery intent. |
