...
| 7a. Persisted Claude queue runtime | In review (current PR) | Fixed private stores, unique lifecycle queue binding, durable producer identity before enqueue, fresh resolver validation and saved-phase restart even after staging-marker loss. [Contract](CLAUDERIG-V2-QUEUE-RUNTIME.md). |
