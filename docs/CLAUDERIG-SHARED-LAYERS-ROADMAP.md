...
| 8b. Codex config portability | In progress | TOML codec (8b.1) merged in [#390](https://github.com/rigsmith/rigsmith/pull/390). Bounded config file capture (8b.2) merged in [#391](https://github.com/rigsmith/rigsmith/pull/391). Machine-local path policy (8b.3) merged in [#392](https://github.com/rigsmith/rigsmith/pull/392). Current: restore preparation and validation boundary (8b.4). Remaining: guarded file replacement/supported-version validation, hooks/customizations, independent state/repository and sync/restore wiring. [Restore contract](CODEXRIG-V2-CONFIG-RESTORE.md). |
