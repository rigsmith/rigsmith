...
// (releasing / private / ignored), and — when some packages would be published
// with no planned version bump (the kind of scope drift demos and test fixtures
// cause) — a fixable warning whose fix opens the include/exclude picker.
