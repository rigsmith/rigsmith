...
The mounted volume is also branded with the app's icon (`.VolumeIcon.icns` + the volume custom-icon flag), so the installer shows the app logo in Finder rather than the generic disk icon.
