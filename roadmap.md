...
Current work is the structured TOML codec and secret-preserving restore (8b.1);
file capture, hooks/customizations, independent state and sync wiring still follow.
...
| Codex config portability (8b) | In progress: internal TOML capture/restore codec (8b.1) in [#390](https://github.com/rigsmith/rigsmith/pull/390). Remaining: file/path and hook/customization processing, independent tool state and backup repository, sync/restore commands. [Contract](docs/CODEXRIG-V2-CONFIG-CODEC.md). |
