...
the explicit manual command is in progress.
...
| Manual queue sync command (7c.2a) | In progress: explicit supervised `queue sync`, dry-run and all-transcript flush; confirm only fully covered pending requests. |
