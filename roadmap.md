...
exact batch acknowledgement. Bounded retry/backoff and explicit failure blocking are in review in [#336](https://github.com/rigsmith/rigsmith/pull/336). Native
conflict recovery, lifecycle/capacity gates and the Codex adapter follow.**
