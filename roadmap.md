...
| 8b.6. Supported-version validation | In progress | 8b.6a merged in [#397](https://github.com/rigsmith/rigsmith/pull/397): pinned Codex 0.144.6 schema and profile overlays. Provider/MCP rules merged in [#400](https://github.com/rigsmith/rigsmith/pull/400). Current 8b.6b: trusted layer composition and permission catalog/selection checks. Remaining: layer discovery/freshness, permission compilation/other requirements, dependencies and credentials. [Contract](docs/CODEXRIG-V2-CONFIG-VALIDATION.md). |
