...
In progress: explicit HTTPS credential-helper lookup with pinned repository/account and bounded process cleanup. SSH-agent support, platform helper selection, native conflict recovery and lifecycle integration follow.**
