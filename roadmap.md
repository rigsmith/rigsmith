...
| Unresolved merge recovery: private audited plan | In progress. Recreate supported conflicts privately, validate index provenance, and export an audited candidate without changing staging. |
