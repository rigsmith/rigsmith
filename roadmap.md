...
| Explicit queued Claude commands (7b) | In review (current PR): init, saved producer requests, enqueue, supervised foreground worker, status/retry and drain. [Contract](docs/CLAUDERIG-V2-QUEUE-COMMANDS.md). |
