...
| Unresolved merge recovery: safe application and restart | In progress. Seal a repair intent, preserve later edits, durably install files/index, and resume interrupted staging. |
