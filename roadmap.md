...
Concrete HTTPS/local Git transport and cancellation cleanup merged in [#323](https://github.com/rigsmith/rigsmith/pull/323). Cleanup for all retained Git commands and streamed validation merged in [#324](https://github.com/rigsmith/rigsmith/pull/324). SSH transport with explicit keys and host trust is in progress;
