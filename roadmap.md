...
Retained manifest/device conflict recovery is in review in [#337](https://github.com/rigsmith/rigsmith/pull/337). Transcript/file and
...
Also queued for v1/v2: validate manifest link endpoints at restore time, including
older and manually edited backups; retained conflict checks alone do not cover them.
