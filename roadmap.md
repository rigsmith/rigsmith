...
Current work applies machine-local TOML path policy (8b.3). Guarded restore and
usable-config validation, hooks/customizations, independent state and sync wiring still follow.
