...
chunked-transcript recovery. Ordinary-file snapshot ordering merged in [#343](https://github.com/rigsmith/rigsmith/pull/343). Completion of already-staged canonical merges is in progress. Unresolved merge recovery,
...
| Canonical staging merge recovery: staged resolutions | In progress. Audit and finish an already-staged merge before retrying a committed batch; preserve the index and unstaged files. |
...
Staged canonical merge completion is in progress; unresolved recovery and capture integration are next. Queued hooks stay disabled.
