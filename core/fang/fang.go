...
//
// This is a vendored fork of github.com/charmbracelet/fang (MIT, see
// LICENSE.md), pinned because upstream has been dormant. Local changes vs
// upstream v0.4.4:
//   - command aliases are shown in the help command list ("format, fmt")
//   - WithHelpAppender, to append custom sections after the standard help
//     (upstream PR #88)
...
// HelpAppender appends custom content to the help output. It receives the
...
// WithHelpAppender sets a callback invoked after fang renders the standard
// help content, letting callers append custom sections (env vars, examples,
// feedback links, …) while keeping fang's styling.
